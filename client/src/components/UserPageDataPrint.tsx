  ...
  const handleSearch = () => {
    ...
    if (filteredResults.length > 0) {
      ...
      filteredResults.forEach((matchedData) => {
        axios
          .post("https://voterapp-backend.onrender.com/post/form", {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <i className="fa fa-home" aria-hidden="true"></i>Exit
          </span>
        </div>
        <h1>Voter Application</h1>
        <div
          style={{ background: "white", width: "400px", padding: "20px" }}
          className="mt-5"
        >
          <div className="mb-5">
            <input
            ...
            {filteredData.map((voter, index) => (
              <div
                key={index}
                onClick={() => handleNameClick(voter.FM_NAME_EN)}
              >
            ...
            {filteredData.map((voter, index) => (
              <div
                key={index}
                onClick={() => handleVoterIdClick(voter.EPIC_NO)}
              >
                {voter.EPIC_NO}
              </div>
            ))}
...
/> */}
            ...
            {filteredData.map((voter, index) => (
              <div
                key={index}
                onClick={() => handleHouseClick(voter.C_HOUSE_NO)}
              >
                {voter.C_HOUSE_NO}
              </div>
            ))}
      ...
      {filteredData.map((voter: any, index: any) => (
        <div
          ...
          style={{
            ...
            width: "100%",
            maxWidth: "400px",
            border: "3px solid orange", // Add an orange border of 3px
          }}
        >
          <div
            ref={pdfRef}
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between mt-3">
                <h5 className="text-2xl text-black  tracking-widest">
                  Voter ID
                </h5>
